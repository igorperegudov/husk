...
A handful of small skills that together cover every mode. Each is a folder with a `SKILL.md` and a kernel; the full set ships in the [`examples/`](https://github.com/elisymlabs/husk/tree/main/examples) directory of the repo.
...
```bash
git clone https://github.com/elisymlabs/husk
