...
The `husk` CLI - [HUSK](https://github.com/igorperegudov/husk), the HTTP Universal
...
That is the whole skill. See the [HUSK guide](https://github.com/igorperegudov/husk/blob/main/GUIDE.md)
